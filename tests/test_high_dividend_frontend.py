...
class FrontendContractTests(unittest.TestCase):
    def test_page_exposes_radar_controls_and_detail_sections(self):
        ...
        for token in ["stable", "cyclical", "status-filter", "industry-filter", "search-input", "stock-detail", "当前 / 目标股息率", "距关注价", "PE TTM / 5年分位", "做T位置"]:
    ...
    def test_script_loads_snapshot_and_declares_all_states(self):
        ...
        for token in ["股息与估值", "做 T 辅助", "市盈率 TTM", "PE近5年分位", "pePercentile5y", "20日支撑", "20日压力", "yield-compare", "distanceToAttention", "fitScore"]:
